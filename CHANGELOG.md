...
* **openAi:** enhance output handling and update tests for receipt analysis ([fc134e9](https://github.com/jvmonjo/dietator/commit/fc134e933218595d8b3016a870afefeefea2c368))
...
* updated calculated weekly average ([41e56d9](https://github.com/jvmonjo/dietator/commit/41e56d92c1286088639bb8076286b5587560cb30))
...
* implemented audio and vibration feedback for success qr code scan ([cc9310f](https://github.com/jvmonjo/dietator/commit/cc9310f28bab03efe691b3ce0d708b2235898dfe))
...
* Update PWA toast action to use `refreshApp` and `swUpdateTrigger` state. ([8f86557](https://github.com/jvmonjo/dietator/commit/8f86557a4b48245f91d00964eca1eb710c370bf1))
...
* add chevron left and right heroicons to Nuxt icon module configuration ([708e7fc](https://github.com/jvmonjo/dietator/commit/708e7fc47c2171441d9a27c833e68960a8afee44))
...
* Add PWA manifest link and update manifest scope and start URL to use baseURL. ([357d058](https://github.com/jvmonjo/dietator/commit/357d058b4a1bc2964a87ba1009dc92c9647dad2f))
