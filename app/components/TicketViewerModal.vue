...
<template>
  <div v-if="isOpen" class="fixed inset-0 z-[70] flex items-stretch justify-center sm:items-center sm:p-4">
    ...
    <div
      ...
      <div class="flex shrink-0 items-center justify-between gap-3 border-b border-gray-200 p-4 dark:border-gray-800">
      ...
      <div class="min-h-0 flex-1 overflow-auto bg-gray-950 p-2">
        <img
