...
| Variable | Descripció |
| --- | --- |
| `[origin_province]` | Província d'origen definida a Settings. |
| `[origin_municipality]` | Municipi d'origen. |
...
| `[service_origin_province]` / `[service_origin_municipality]` | Copia de la configuració global en el moment de generar el document. |
...
Ruta: [origin_province] → [displacement_province] / [displacement_municipality]
